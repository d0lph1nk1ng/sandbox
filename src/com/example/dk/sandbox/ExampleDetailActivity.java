...
public class ExampleDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			String id = getIntent().getStringExtra(ExampleDetailFragment.ARG_ITEM_ID);
			arguments.putString(ExampleDetailFragment.ARG_ITEM_ID, id);
			Class cls = null;
			try {
				cls = Class.forName(this.getClass().getPackage().getName() + "." + ExampleContent.ITEM_MAP.get(id).className);
			...
			if(cls != null) {
				...
				if(instance != null) {
					ExampleDetailFragment fragment = (ExampleDetailFragment)instance;
					fragment.setArguments(arguments);
					getSupportFragmentManager().beginTransaction()
							.add(R.id.example_detail_container, fragment).commit();
				}
			}
		}
	}
